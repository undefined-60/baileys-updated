...
authState = {
	...
	printQRInTerminal = !authState.creds.me;
	...
	const validateConnection = async() => {
		...
		const config = { version: (await fetchLatestWaWebVersion()).version, browser, syncFullHistory };
